...
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! @ionic/storage */ "./node_modules/@ionic/storage/fesm5/ionic-storage.js");
...
var ImagenPipe = /** @class */ (function () {
    ...
    ImagenPipe.prototype.transform = function (img, tipo) {
        ...
        var url = _services_global_service__WEBPACK_IMPORTED_MODULE_2__["Global"].url + 'img';
        if (!img) {
...
var AdsComponent = /** @class */ (function () {
    function AdsComponent(route, router, fsApi) {
        this.route = route;
        this.router = router;
        this.fsApi = fsApi;
    ...
    AdsComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            _this.subscribedParam = params.get("tipo");
        });
        console.log(this.subscribedParam);
    };
    AdsComponent.prototype.onPlayerReady = function (player) {
        var _this = this;
        this.api = player;
        this.api.getDefaultMedia().subscriptions.loadStart.subscribe(function (a) {
        });
        var subscriptions = this.api.getDefaultMedia();
        this.api.getDefaultMedia().subscriptions.play.subscribe(function (a) {
            console.log("Esta PLay");
            _this.active = true;
        });
        subscriptions.subscriptions.ended.subscribe(function (a) {
            // http://localhost:4200/principal/player/55
            _this.router.navigate(['/principal/player', _this.subscribedParam]);
        });
        subscriptions.subscriptions.emptied.subscribe(function (a) {
    ...
    AdsComponent.ctorParameters = function () { return [
...
var AccountComponent = /** @class */ (function () {
    function AccountComponent(local) {
        this.local = local;
        this.usuario = [];
        this.getUsuario();
    ...
    AccountComponent.prototype.getUsuario = function () {
        var _this = this;
        this.local.cargarStorage('usuario').then(function (data) {
            _this.usuario = data;
        }).catch(function (err) {
            throw err;
        });
    };
    AccountComponent.prototype.actualizar = function () {
    };
...
var AlquileresComponent = /** @class */ (function () {
    function AlquileresComponent(api, local, router) {
        this.api = api;
        this.local = local;
        this.router = router;
        this.categoria = {
    ...
    AlquileresComponent.prototype.ngOnInit = function () {
    };
    AlquileresComponent.prototype.getUser = function () {
        var _this = this;
        this.local.cargarStorage('usuario').then(function (data) {
            _this.usuario = data;
            _this.Alquileres(_this.usuario.id, _this.categoria.id);
        });
    };
    AlquileresComponent.prototype.Alquileres = function (id, cat) {
        var _this = this;
        this.api.getAlquileres(id, cat).subscribe(function (resp) {
            _this.items = resp;
        });
    };
    AlquileresComponent.prototype.openload = function (id) {
        this.router.navigate(['/principal/load', id]);
    };
    AlquileresComponent.ctorParameters = function () { return [
...
var CarritoComponent = /** @class */ (function () {
    function CarritoComponent(local, http, api, router) {
        this.local = local;
        this.http = http;
        this.api = api;
        this.router = router;
    ...
    CarritoComponent.prototype.getCarrito = function () {
        var _this = this;
        this.local.cargarStorage('carrito').then(function (data) {
            _this.productos = data;
        });
    };
    CarritoComponent.prototype.getUser = function () {
        var _this = this;
        this.local.cargarStorage('usuario').then(function (data) {
            _this.usuario = data;
        });
    };
    CarritoComponent.prototype.cambiar = function (event, id, precio, name) {
        var _this = this;
        var data = {
            id: id,
            precio: precio,
        ...
        var existe = this.productos_detalle.findIndex(function (e) { return e.id == data.id; });
        if (existe != -1) {
        ...
        this.total1 = 0;
        this.productos_detalle.forEach(function (a) {
            _this.total1 += a.subtotal;
        });
        this.total = this.total1;
    };
    CarritoComponent.prototype.eliminarproducto = function (id) {
        var _this = this;
        var eliminar = this.productos_detalle.find(function (e) { return e.id == id; });
        if (!eliminar) {
            this.cantidad = 0;
            this.precio = 0;
        }
        ...
        var nuevo = this.productos_detalle.filter(function (productos_detalle) { return productos_detalle.id !== id; });
        ...
        var newStorage = this.productos.filter(function (productos) { return productos.id !== id; });
        this.productos = newStorage;
        this.local.eliminarStorage('carrito');
        this.local.SaveStorage('carrito', this.productos);
    };
    CarritoComponent.prototype.confirmPayment = function () {
        var _this = this;
        ...
        this.api.crearOrdenes(this.datos_compra).subscribe(function (resp) {
            if (resp.ok == true) {
                _this.basicmodal.hide();
                _this.compra_preparada = true;
                _this.paymentPayload = {
                    ...
                    test: 1,
                    amount: resp.amount,
                    buyerEmail: _this.usuario.email //0        
                };
                console.log(_this.paymentPayload);
            }
        });
    };
    CarritoComponent.prototype.direccionar = function () {
        this.local.eliminarStorage('carrito');
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, store, local) {
        var _this = this;
        this.router = router;
        this.store = store;
        this.local = local;
        ...
        this.local.cargarStorage('carrito').then(function (data) {
            _this.productos = data;
            _this.contador = _this.productos.length;
        });
    }
...
var LoadmovieComponent = /** @class */ (function () {
    function LoadmovieComponent(route, api) {
        this.route = route;
        this.api = api;
        this.snapshotParam = "initial value";
        this.subscribedParam = "initial value";
    ...
    LoadmovieComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.snapshotParam = this.route.snapshot.paramMap.get("source");
        // Subscribed
        this.route.paramMap.subscribe(function (params) {
            _this.subscribedParam = params.get("source");
        });
        this.getProducto(this.subscribedParam);
    };
    LoadmovieComponent.prototype.getProducto = function (id) {
        var _this = this;
        this.api.getProducto(id).subscribe(function (resp) {
            _this.item = resp[0];
            _this.url_video = "https://player.vimeo.com/video/" + _this.item.url + "?autoplay=1&title=0&byline=0&portrait=0";
            console.log(_this.item);
        });
    };
    LoadmovieComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
var MiscomprasComponent = /** @class */ (function () {
    function MiscomprasComponent(api, local) {
        this.api = api;
        this.local = local;
        this.usuario = [];
        this.ordenes = [];
    ...
    MiscomprasComponent.prototype.getOrdenes = function () {
        var _this = this;
        this.api.getOrdenes(this.usuario.email).subscribe(function (resp) {
            _this.ordenes = resp;
        });
    };
    MiscomprasComponent.prototype.getUser = function () {
        var _this = this;
        this.local.cargarStorage('usuario').then(function (data) {
            _this.usuario = data;
            _this.getOrdenes();
    ...
    MiscomprasComponent.prototype.vermas = function (id) {
        var _this = this;
        this.api.getProductosOrdenes(id).subscribe(function (resp) {
            _this.productos = resp;
            _this.basicModal.show();
            console.log(_this.productos);
        });
    };
    MiscomprasComponent.ctorParameters = function () { return [
        { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
        { type: src_app_services_local_storage_service__WEBPACK_IMPORTED_MODULE_3__["LocalStorageService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var MultimediaComponent = /** @class */ (function () {
    function MultimediaComponent(store, api, router) {
        this.store = store;
        this.api = api;
        this.router = router;
        this.categoria = {
    ...
    MultimediaComponent.prototype.OpenModal = function (id) {
        this.router.navigate(['/principal/review', id]);
    };
    MultimediaComponent.prototype.GetProductos = function (id) {
        var _this = this;
        this.api.getProductos(id).subscribe(function (resp) {
            _this.items = resp;
        });
    };
    MultimediaComponent.prototype.agregar = function (id) {
        this.store.addproducto(id).subscribe(function (resp) {
        });
    };
...
var PlayerComponent = /** @class */ (function () {
    function PlayerComponent(fsApi, route, contenido) {
        this.fsApi = fsApi;
        this.route = route;
    ...
    PlayerComponent.prototype.getSource = function (id) {
        var _this = this;
        this.contenido.getContenido(id).subscribe(function (resp) {
            console.log(resp);
            if (resp.ok == true) {
                var tipo = resp.results[0].tipo;
                _this.source = {
    ...
    PlayerComponent.prototype.onPlayerReady = function (player) {
        var _this = this;
        this.api = player;
        this.api.getDefaultMedia().subscriptions.loadStart.subscribe(function (a) {
            _this.playAudio();
        ...
        subscriptions.subscriptions.ended.subscribe(function (a) {
            _this.ads = false;
            _this.getSource(_this.subscribedParam);
        });
        this.api.getDefaultMedia().subscriptions.loadedMetadata.subscribe(function (a) {
            _this.playAudio();
        }, function (error) {
            console.log(error);
        });
        this.api.fsAPI.onChangeFullscreen.subscribe(function (a) {
            if (_this.api.fsAPI.isFullscreen) {
                _this.fulls = false;
            }
            else {
                _this.fulls = true;
    ...
    PlayerComponent.prototype.playAudio = function () {
        this.api.play();
    };
    PlayerComponent.prototype.errorAudio = function (event) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Radio Error Prueba otra emisora');
    };
    PlayerComponent.prototype.stopAudio = function () {
        this.api.pause();
        this.stado = false;
    };
    PlayerComponent.prototype.setAudio = function () {
        this.loading = false;
        this.audio = true;
    };
    PlayerComponent.prototype.setVideo = function () {
        this.loading = false;
        this.video = true;
    };
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(store, api, router) {
        this.store = store;
        this.api = api;
        this.router = router;
        this.categoria = {
    ...
    ProductsComponent.prototype.OpenModal = function (id) {
        this.router.navigate(['/principal/review', id]);
    };
    ProductsComponent.prototype.GetProductos = function (id) {
        var _this = this;
        this.api.getVideos(id).subscribe(function (resp) {
            _this.items = resp;
        });
    };
    ProductsComponent.prototype.agregar = function (id) {
        this.store.addproducto(id).subscribe(function (resp) {
        }, function (error) {
            console.log(error);
        });
...
var RadioComponent = /** @class */ (function () {
    function RadioComponent(contenido, router) {
        this.contenido = contenido;
        this.router = router;
        this.radios = [];
        this.idiomas = [];
    ...
    RadioComponent.prototype.getRadios = function (id) {
        var _this = this;
        this.contenido.getEmisoras(id).subscribe(function (resp) {
            _this.radios = resp;
        });
    };
    RadioComponent.prototype.filtrar = function (event) {
        this.data = event;
        this.getRadios(this.data);
    };
    RadioComponent.prototype.openMedios = function (radio) {
...
var ReviewComponent = /** @class */ (function () {
    function ReviewComponent(store, api, route) {
        this.store = store;
        this.api = api;
        this.route = route;
        this.snapshotParam = "initial value";
    ...
    ReviewComponent.prototype.getProducto = function (id) {
        var _this = this;
        this.api.getProducto(id).subscribe(function (resp) {
            _this.item = resp[0];
        });
    };
    ReviewComponent.prototype.agregar = function (id) {
        this.store.addproducto(id).subscribe(function (resp) {
        }, function (error) {
            console.log(error);
        });
...
var StoreComponent = /** @class */ (function () {
    function StoreComponent(api, local) {
        this.api = api;
        this.local = local;
        this.categorias = [];
        this.alquiler = false;
    ...
    StoreComponent.prototype.getCategorias = function () {
        var _this = this;
        this.api.getCategorias().subscribe(function (resp) {
            _this.categorias = resp;
            console.log(_this.categorias);
        });
    };
    StoreComponent.prototype.visualizar = function (id) {
        if (id == 1) {
            this.oferta = true;
            this.alquiler = false;
        }
...
var TvComponent = /** @class */ (function () {
    function TvComponent(contenido, router) {
        this.contenido = contenido;
        this.router = router;
        this.tvs = [];
        this.data = 0;
    ...
    TvComponent.prototype.getTv = function (data) {
        var _this = this;
        this.contenido.getTv(data).subscribe(function (resp) {
            _this.tvs = resp;
        });
    };
    TvComponent.prototype.filtrar = function (event) {
        this.data = event;
        this.getTv(this.data);
    };
    // OpenPublicidad() {
    ...
    //   }, 30000);
    // }
    TvComponent.prototype.openTv = function (tv) {
        this.source = tv.id;
        this.router.navigate(['/principal/player', this.source]);
    };
...
var VideosComponent = /** @class */ (function () {
    ...
    VideosComponent.prototype.getCategorias = function () {
        var _this = this;
        this.api.getPCategorias().subscribe(function (resp) {
            _this.categorias = resp;
            console.log(_this.categorias);
        });
    };
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.ocultarmenu = function () {
        console.log("entro");
        if (this.menu == false) {
            this.menu = true;
        }
...
var TopnavbarComponent = /** @class */ (function () {
    function TopnavbarComponent(contenido) {
        this.contenido = contenido;
    ...
    TopnavbarComponent.prototype.cargarIdiomas = function () {
        var _this = this;
        this.contenido.getIdiomas().subscribe(function (resp) {
            _this.idiomas = resp;
        });
    };
    TopnavbarComponent.prototype.cambiarIdioma = function (data) {
...
var PublicidadComponent = /** @class */ (function () {
    function PublicidadComponent(api) {
        this.api = api;
        this.images = [];
        this.items = [];
        this.getBanners();
    ...
    PublicidadComponent.prototype.getBanners = function () {
        var _this = this;
        this.api.getBanners().subscribe(function (resp) {
            _this.items = resp;
    ...
    PublicidadComponent.ctorParameters = function () { return [
        { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.Existeusuario = function (control) {
        return this.loginservice.checkEmail(control.value).map(function (resp) {
            return resp.email ? null : { emailTaken: true };
        });
    };
    LoginComponent.prototype.Login = function () {
        var _this = this;
        this.loginservice.login(this.login.value).subscribe(function (resp) {
            _this.usuario = resp;
            // this.storage.SaveStorage(this.usuario);
            _this.router.navigate(['/principal/home']);
        }, function (error) {
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(login, router) {
        this.login = login;
        this.router = router;
        this.logo = "logo.png";
    ...
    RegisterComponent.prototype.registrarse = function () {
        var _this = this;
        this.login.register(this.register.value).subscribe(function (resp) {
            if (resp.ok == true) {
...
var StartComponent = /** @class */ (function () {
    ...
    StartComponent.prototype.selectIdioma = function (id) {
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getIdiomas = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "idiomas", { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getEmisoras = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "emisoras/" + id, { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getTv = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "tv/" + id, { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getContenido = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "multimedia/" + id, { headers: headers });
    };
    //publicidad
    ApiService.prototype.getBanners = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "banners", { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getVideoPublicidad = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "videosp", { headers: headers }).map(function (resp) { return resp.results; });
    };
    //tienda
    ApiService.prototype.getProductos = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "productos/" + id, { headers: headers }).map(function (resp) { return resp.results; });
    };
    //videos a la carta 
    ApiService.prototype.getVideos = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "video/" + id, { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getCategorias = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "categorias", { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getPCategorias = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "pcategorias", { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.crearOrdenes = function (data) {
        var params = JSON.stringify(data);
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.post(this.url + "ordenes", params, { headers: headers });
    };
    ApiService.prototype.getOrdenes = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "ordenes/" + id, { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getProductosOrdenes = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "compras/" + id, { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getAlquileres = function (id, categoria) {
        console.log(id + '-' + categoria);
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "alquileres/" + id + "/" + categoria, { headers: headers }).map(function (resp) { return resp.results; });
    };
    ApiService.prototype.getProducto = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.get(this.url + "cartavideo/" + id, { headers: headers }).map(function (resp) { return resp.results; });
    };
...
var LocalStorageService = /** @class */ (function () {
    function LocalStorageService(platform, storage) {
        this.platform = platform;
        this.storage = storage;
        this.isDesktopDevice = null;
    }
    LocalStorageService.prototype.SaveStorage = function (key, value) {
    ...
    LocalStorageService.prototype.cargarStorage = function (key) {
        var _this = this;
    ...
    LocalStorageService.prototype.eliminarStorage = function (key) {
        if (this.platform.isBrowser) {
...
var LoginService = /** @class */ (function () {
    function LoginService(handler, platform, storage) {
        this.platform = platform;
        this.storage = storage;
    ...
    LoginService.prototype.login = function (data) {
        ...
        return this.http.post(this.url + 'login', params, { headers: headers }).map(function (resp) {
            console.log(resp);
            if (_this.platform.isBrowser) {
                ...
                _this.storage.set('usuario', JSON.stringify({
                    name: resp.name,
                    surname: resp.surname,
                    email: resp.email,
                    telefono: resp.telefono,
    ...
    LoginService.prototype.register = function (data) {
        var params = JSON.stringify(data);
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.post(this.url + 'register', params, { headers: headers }).map(function (resp) { return resp; });
    };
...
var StoreService = /** @class */ (function () {
    function StoreService(http, local) {
        this.http = http;
        this.local = local;
        this.productos = [];
        this.url = _global_service__WEBPACK_IMPORTED_MODULE_4__["Global"].url;
    }
    StoreService.prototype.addproducto = function (id) {
        var _this = this;
        this.local.cargarStorage('carrito').then(function (data) {
            _this.productos = data;
        ...
        var existe = this.productos.findIndex(function (e) { return e.id == id; });
        if (existe === -1) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
            return this.http.get(this.url + "cartavideo/" + id, { headers: headers }).map(function (resp) {
                _this.productos.push(resp.results[0]);
                _this.local.SaveStorage('carrito', _this.productos);
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
                    position: 'top-end',
                    type: 'success',

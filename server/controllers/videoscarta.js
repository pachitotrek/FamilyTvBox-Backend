...
const cartaController = {
    ...
    addVideo: function (req, res) {
        const body = req.body;
        let query = `INSERT INTO productos (name, descripcion, precio,servidor,url, categoria, time, disponible,tipo) VALUES ('${body.name}','${body.descripcion}','${body.precio}','${body.servidor}','${body.url}','${body.categoria}','${body.time}','${body.disponible}','${body.tipo}')`;
        Mysql.BaseDatosController.EjecutarQuery(query, res, false);
    },
    editarVideo: function (req, res) {
        const body = req.body;
        let query = `UPDATE productos SET name='${body.name}',descripcion='${body.descripcion}',precio='${body.precio}',servidor='${body.servidor}',url='${body.url}',categoria='${body.categoria}',
    ...
    getSeries:function(req,res){
        let query = `SELECT * FROM productos WHERE tipo = 3 `;
        Mysql.BaseDatosController.EjecutarQuery(query, res, true);
    },
